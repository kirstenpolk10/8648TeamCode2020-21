...
import org.firstinspires.ftc.teamcode.Team8648HardwarePushbot;
    ...
    public void runOpMode() {
        ...
        switch(Square) {
            case BLUE_A: // no rings. 3 tiles (24 inches per tile) forward and one tile to the left from start
                telemetry.addData("Going to BlUE A", "Target Zone"); // change the message of you are going to BLUE to avoid confusion
                robot.claw.setPosition(0);
                encoderDrive(DRIVE_SPEED, 73, 73,8);
            ...
            case BLUE_B: // one ring  4 tiles straight ahead
                ...
                //runtime.reset();
                robot.claw.setPosition(0);
                encoderDrive(DRIVE_SPEED, 90,90,7);
                encoderDrive(TURN_SPEED, -5, 5, 2);
            ...
            case BLUE_C: // four rings. 5 tiles forward and one tile to the left.
                ...
                //runtime.reset();
                robot.claw.setPosition(0);
                encoderDrive(DRIVE_SPEED, 110, 110, 8);
                encoderDrive(TURN_SPEED,5,-5, 2);
                sleep(7000);
                robot.claw.setPosition(1);
                sleep(1000);
